...
print(args)
print(rest)
os.system("git clone https://{0}@github.com/xvjiarui/Flow-Guided-Feature-Aggregation.git -b {1} $HOME/FGFA".format(args.auth, args.branch))
os.chdir(os.path.expanduser('~/FGFA'))
