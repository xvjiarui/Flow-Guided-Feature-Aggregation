...
class ProposalTargetOperator(mx.operator.CustomOp):
    def __init__(self, num_classes, batch_images, batch_rois, cfg, fg_fraction, rois_index):
    ...
    def forward(self, is_train, req, in_data, out_data, aux):
        ...
        all_rois[:, 0] = self._rois_index
        assert np.all(all_rois[:, 0] == self._rois_index), 'Only single item batches are supported'
...
class ProposalTargetProp(mx.operator.CustomOpProp):
    def __init__(self, num_classes, batch_images, batch_rois, cfg, fg_fraction='0.25', rois_index=0):
    ...
    def create_operator(self, ctx, shapes, dtypes):
        return ProposalTargetOperator(self._num_classes, self._batch_images, self._batch_rois, self._cfg, self._fg_fraction, self._rois_index)
